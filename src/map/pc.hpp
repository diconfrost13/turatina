...
struct s_player_bonus_db {
	struct script_code *script;
	player_bonus_type type;
...
class PlayerBonusDatabase : public TypesafeYamlDatabase<uint32, s_player_bonus_db> {
public:
	PlayerBonusDatabase() : TypesafeYamlDatabase("PLAYER_BONUS", 1) {
...
extern PlayerBonusDatabase player_bonus_db;
